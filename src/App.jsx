      ...
      <div id="contenido">
        <div className="bg-image">
            ...
            <div className="hero-content text-center w-full h-3/4">
              <div className="max-w-md h-3/4 flex flex-col justify-center items-center">
                ...
                <div className="relative flex flex-row justify-center">
                  <p className="absolute text-lg italic tooltip-text w-40">
                    Pulsa para empezar...
                  </p>
                <button
                  className="flecha w-8 mb-0 mt-auto relative"
                  onClick={() => start()}
                >
          ...
          >
            <div className="hero-content text-center main-hero w-full h-3/4">
              <div className="max-w-md">
                ...
                <p className="py-6 text-3xl italic">
                  Acompañanos a celebrar...
                </p>
                <button
                  className="flecha"
                  onClick={() => handleNextClick(section2Ref)}
                >
                  <img className="w-8" src={downArrow} alt="arrow icon" />
                </button>
              </div>
          ...
          <div
            ref={section2Ref}
            id="section2"
            className="hero min-h-screen main-hero bg-customPastel"
          >
              ...
              <div className="max-w-md">
                <div className="">
                  ...
                  <p className="text-2xl mt-4">
                    Damos el{" "}
                    <span className="text-customPastel1 text-2xl">SI</span>
                  </p>
                  <p className="text-2xl">
                    Y queremos que seas testigo de nuestra alegría en ese día
                    tan especial. Así que prepara tus mejores pasos de baile y
                    tu sonrisa más grande, porque vamos a celebrar nuestro gran
                    amor.
                  </p>
                </div>
                ...
                <button
                  className="flecha"
                  onClick={() => handleNextClick(section3Ref)}
                >
          ...
          >
            <div className="hero-content main-hero text-center h-3/4">
              <div className="max-w-md">
                ...
                <p className="text-2xl">
                  Además, nos emociona compartir con vos un momento muy
                  especial, durante la celebración realizaremos una ceremonia
                  simbólica para sellar nuestra unión. Será una ocasión llena de
                  amor, en la que seremos guiados por personas especiales en
                  nuestras vidas.
                </p>
                <p className="text-2xl">
                  ¡Estamos ansiosos por compartir este momento único!
                </p>
                <button
                  className="flecha mt-2"
                  onClick={() => handleNextClick(section4Ref)}
                >
                  <img className="w-8" src={downArrow} alt="arrow icon" />
                </button>
              </div>
          ...
          <div
            ref={section4Ref}
            id="section4"
            className="hero min-h-screen main-hero bg-customPastel2"
          >
                ...
                <div className="text-center flex flex-col justify-center">
                  ...
                  >
                    <img
                      src={locationIcon}
                      alt="location icon"
                      className="w-8 sombra"
                    />
                  </a>
                </div>
                <button
                  className="mt-2 flecha"
                  onClick={() => handleNextClick(section5Ref)}
                >
                  <img className="w-8" src={downArrow} alt="arrow icon" />
                </button>
              </div>
          ...
          <div
            ref={section5Ref}
            id="section5"
            className="hero min-h-screen main-hero bg-transparent"
          >
            <div className="hero-content text-center main-hero h-3/4">
              <div className="max-w-md">
                <button
                  className="flecha transform pb-4"
                  onClick={() => handleNextClick(section4Ref)}
                >
                  <img
                    className="w-8 rotate-180"
                ...
                <div className="mb-2 p-1">
                  <p className="text-2xl">
                    Nuestro mayor regalo en esa noche tan especial, será tu
                    presencia.
                  </p>
                  <p className="text-2xl">
                    Pero si deseas colaborar con nuestra luna de miel habrá un
                    buzón en el salón o en estas cuentas:
                  </p>
                  <CopyToClipboardButton />
                </div>
                <button
                  className="mt-2 flecha"
                  onClick={() => handleNextClick(section6Ref)}
                >
                  <img className="w-8" src={downArrow} alt="arrow icon" />
                </button>
              </div>
          ...
          <div
            ref={section6Ref}
            id="section6"
            className="hero min-h-screen main-hero bg-customPastel3"
          >
            <div className="hero-content text-center">
